    ...
    return (
        <ul className="side-nav">
            ...
            <li className="side-nav-item">
                ...
                <div className={`collapse ${isDropdownActive(['category.index', 'subcategory.index', 'childcat.index', 'subchildcat.index']) ? 'show' : ''}`} id="Categories">
                    <ul className="side-nav-second-level">
                        ...
                        <li className={`side-nav-item ${isActive('subcategory.index') ? 'active-link' : ''}`}>
                            <Link className="side-nav-link" href={route('subcategory.index')}>
                                All Sub Categories
                            </Link>
                        </li>
                        <li className={`side-nav-item ${isActive('childcat.index') ? 'active-link' : ''}`}>
                            <Link className="side-nav-link" href={route('childcat.index')}>
                                All Child Categories
                            </Link>
                        </li>
                        <li className={`side-nav-item ${isActive('subchildcat.index') ? 'active-link' : ''}`}>
                            <Link className="side-nav-link" href={route('subchildcat.index')}>
            ...
            <li className="side-nav-item">
                <Link
                    data-bs-toggle="collapse"
                    href="#Users"
                    aria-expanded={isDropdownActive(['users.index', 'users.create'])}
                    aria-controls="Users"
                    className="side-nav-link"
                >
                ...
                <div className={`collapse ${isDropdownActive(['users.index', 'users.create']) ? 'show' : ''}`} id="Users">
                    <ul className="side-nav-second-level">
                        ...
                        <li className={`side-nav-item ${isActive('users.create') ? 'active-link' : ''}`}>
                            <Link className="side-nav-link" href={route("users.create")}>
                                Add User
                            </Link>
                        </li>
                    </ul>
            ...
            <li className="side-nav-item">
                <Link
                    data-bs-toggle="collapse"
                    href="#Roles"
                    aria-expanded={isDropdownActive(['roles.index', 'roles.create'])}
                    aria-controls="Roles"
                    className="side-nav-link"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-user-check">
                ...
                <div className={`collapse ${isDropdownActive(['roles.index', 'roles.create']) ? 'show' : ''}`} id="Roles">
                    <ul className="side-nav-second-level">
                        ...
                        <li className={`side-nav-item ${isActive('roles.create') ? 'active-link' : ''}`}>
                            <Link className="side-nav-link" href={route("roles.create")}>
                                Add Role
                            </Link>
                        </li>
                    </ul>
            ...
            <li className="side-nav-item">
                <Link
                    data-bs-toggle="collapse"
                    href="#Permissions"
                    aria-expanded={isDropdownActive(['permissions.index', 'permissions.create'])}
                ...
                <div className={`collapse ${isDropdownActive(['permissions.index', 'permissions.create']) ? 'show' : ''}`} id="Permissions">
                    <ul className="side-nav-second-level">
                        ...
                        <li className={`side-nav-item ${isActive('permissions.create') ? 'active-link' : ''}`}>
                            <Link className="side-nav-link" href={route("permissions.create")}>
                                Add Permission
                            </Link>
                        </li>
                    </ul>
            ...
            <li className="side-nav-item">
                <Link
                    data-bs-toggle="collapse"
                    href="#Package"
                    aria-expanded={isDropdownActive(['package.index', 'package.create'])}
                ...
                <div className={`collapse ${isDropdownActive(['package.index', 'package.create']) ? 'show' : ''}`} id="Package">
                    <ul className="side-nav-second-level">
                        <li className={`side-nav-item ${isActive('package.index') ? 'active-link' : ''}`}>
                            <Link className="side-nav-link" href={route("package.index")}>
                                All Packages
                            </Link>
                        </li>
                        <li className={`side-nav-item ${isActive('package.create') ? 'active-link' : ''}`}>
                            <Link className="side-nav-link" href={route("package.create")}>
                                Add Package
                            </Link>
                        </li>
                    </ul>
            ...
            <li className="side-nav-item">
                <Link
                    data-bs-toggle="collapse"
                    href="#Profile"
                    aria-expanded={isDropdownActive(['profile.edit', 'change.password'])}
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-user">
                        <path d="M20.24 8.24a6.7 6.7 0 0 0 0-9.48 6.7 6.7 0 0 0-9.48 0l-7.5 7.5a6.7 6.7 0 0 0 0 9.48 6.7 6.7 0 0 0 9.48 0l7.5-7.5z"></path>
                        <circle cx="12" cy="12" r="2"></circle>
                        <line x1="19" y1="19" x2="19.01" y2="19"></line>
                    </svg>
                    <span>Profile</span>
                    <span className="menu-arrow" />
                </Link>
                <div className={`collapse ${isDropdownActive(['profile.edit', 'change.password']) ? 'show' : ''}`} id="Profile">
                    <ul className="side-nav-second-level">
                        <li className={`side-nav-item ${isActive('profile.edit') ? 'active-link' : ''}`}>
                            <Link className="side-nav-link" href={route("profile.edit")}>
                                Edit Profile
                            </Link>
                        </li>
                        <li className={`side-nav-item ${isActive('change.password') ? 'active-link' : ''}`}>
                            <Link className="side-nav-link" href={route("change.password")}>
                                Change Password
                            </Link>
                        </li>
                    </ul>
